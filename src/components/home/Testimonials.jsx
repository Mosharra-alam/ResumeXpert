            ...
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg className="mt-0.5" width="12" height="12" viewBox="0 0 12 12" fill-green-500 xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    ...
    <div id= "testimonials"  className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
          ...
          <Title   title="Dont just take our word for it" description="Here's what our users have to say about us.  We always looking for ways to improve. If you have any feedback, please let us know!" />
